...
const Register = ({ setCurrentPage }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!emailRegex.test(trimmedEmail) || /\d$/.test(trimmedEmail)) {
      toast.error("Invalid email format. TLD cannot contain numbers.");
      return;
    }
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="max-w-2xl w-full space-y-8 bg-white dark:bg-gray-800 p-10 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700">
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="col-span-1 md:col-span-2">
              ...
              <input
                ...
                name="name"
                required
                className="appearance-none rounded-lg block w-full px-3 py-3 border border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-colors"
                ...
                <div className="space-y-1 text-center">
                  ...
                  <div className="flex text-sm text-gray-600 dark:text-gray-400">
                    ...
                    >
                      ...
                      <input id="file-upload" name="profileImage" type="file" className="sr-only" onChange={handleFileChange} />
                    </label>
                    <p className="pl-1">or drag and drop</p>
                  </div>
                  <p className="text-xs text-gray-500 dark:text-gray-400">PNG, JPG, GIF up to 10MB</p>
                  {profileImage && <p className="text-sm text-green-500 mt-2">Selected: {profileImage.name}</p>}
                </div>
              </div>
            </div>
          </div>
